...
const features = [
  ...
  { icon: Zap, title: 'Instant Sync', desc: 'Real-time transactions from all your banks' },
  { icon: Smartphone, title: 'Smart Categorization', desc: 'AI automatically categorizes your spending' },
  { icon: TrendingUp, title: 'Actionable Insights', desc: 'Get personalized tips to save more' },
];
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Take control of your finances with AI-powered insights</Text>
        </View>
