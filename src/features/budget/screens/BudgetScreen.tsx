...
import { View, Text, Pressable, ScrollView, SafeAreaView, StyleSheet, Modal, TextInput, KeyboardAvoidingView, Platform, Switch } from 'react-native';
import { useRouter } from 'expo-router';
import { useState } from 'react';
import { ArrowLeft, Plus, Trash2, Edit2, ChevronRight, AlertCircle, CheckCircle, Clock, Target, Bell, DollarSign, MoreHorizontal, X } from 'lucide-react-native';
